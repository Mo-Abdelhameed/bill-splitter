...
def parse_story_file(path: Path) -> Story:
    ...
    # ID in filename must match ID in header
    ...
    # Feature in header should match parent directory
    ...
    # Validate referenced IDs are well-formed
...
def validate_stories(stories: list[Story]) -> None:
    ...
    # Detect cycles in depends_on graph (DFS with coloring)
