...
void main() {
  group('ImageResizerImpl (STORY-003 AC-4 resize math)', () {
    ...
    test(
        'STORY-003 AC-4: a 3200x2000 image resizes so its longest edge is 1600 (aspect ratio preserved)',
        () async {
    ...
    test(
        'STORY-003 AC-4: a 1000x2400 (taller-than-wide) image resizes so its longest edge is 1600',
        () async {
    ...
    test(
        'STORY-003 AC-4: a 1000x800 image (both edges ≤1600) is returned unchanged in dimensions',
        () async {
